...
CREATE TABLE IF NOT EXISTS indicators (
    ...
    box           JSON,
    settings      JSON,
    direction     INT          COMMENT 'Rotation angle in degrees',
    min_value     INT          COMMENT 'Expected minimum value for the indicator',
    max_value     INT          COMMENT 'Expected maximum value for the indicator',
    after_decimal INT          COMMENT 'Number of digits after decimal, 0 or null - none',
    PRIMARY KEY (id),
